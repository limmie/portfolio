  ...
  sections: {
    ...
    works: {
      ...
      items: [
        ...
        {
          name: "Duhoot | Сайт для путешествий",
          types: ["Фронтэнд", "SEO", "Верстка"],
        ...
        {
          name: "Golden One | Сайт Портфолио",
          types: ["Фронтэнд", "SEO", "Верстка"],
